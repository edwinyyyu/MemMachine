"""A/B: Duckling planner OR semantics vs default AND semantics."""
...
from temporal_retrieval_tr.research._duckling_or_planner import DucklingORPlanner
...
async def main():
    ...
    planner = DucklingORPlanner()
    print("\n=== duckling-extr + duckling-OR-plan ===\n", flush=True)
    rows = []
    ...
    print(f"\nMACRO duckling-OR-both:           R@1={r1:.4f}  R@5={r5:.4f}  n={n}",
          flush=True)
    print(f"MACRO duckling-AND-both (orig):    R@1=0.6527  R@5=0.8978", flush=True)
