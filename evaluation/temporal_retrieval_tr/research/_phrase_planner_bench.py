"""Bench: duckling-extr + phrase planner (gpt-5-nano @ minimal)."""
...
async def main():
    ...
    planner = PhrasePlanner(model="gpt-5-nano", reasoning_effort="minimal")
    print("\n=== duckling-extr + phrase-planner (gpt-5-nano @ minimal) ===\n", flush=True)
    rows = []
    ...
    print(f"\nMACRO phrase-plan (nano@min):       R@1={r1:.4f}  R@5={r5:.4f}  n={n}",
          flush=True)
    print("MACRO duckling-extr + LLM-plan:       R@1=0.8013  R@5=0.9533", flush=True)
    print("MACRO duckling-extr + intent-v2-plan: R@1=0.7205  R@5=0.9253", flush=True)
    print("MACRO duckling-both (no LLM):         R@1=0.6527  R@5=0.8978", flush=True)
