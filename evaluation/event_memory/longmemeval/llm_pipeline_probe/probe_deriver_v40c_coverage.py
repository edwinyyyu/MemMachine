"""v40c deriver -- rename COUNTING -> COVERAGE.

Single word; mirrors goal paragraph's "cover every searchable thing".
Drops the "DERIVATIVES" prefix as redundant (whole prompt is about
derivatives).
...
if __name__ == "__main__":
    ...
    if non_ascii:
        ...
        print("All ASCII OK")
    print(
        f"v40c length: {len(PROMPT_DERIVER)} chars / {len(PROMPT_DERIVER.split())} words"
    )
