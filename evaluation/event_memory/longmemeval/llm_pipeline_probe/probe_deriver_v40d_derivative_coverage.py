"""v40d deriver -- v40b with singular DERIVATIVE COVERAGE (vs plural).

English compound-noun idiom: "code coverage", "test coverage" — modifying
noun is singular even when referent is plural. "DERIVATIVE COVERAGE"
reads more naturally than "DERIVATIVES COVERAGE".

Only the header changes vs v40b. Bullet content identical.
"""
...
if __name__ == "__main__":
    ...
    if non_ascii:
        ...
        print("All ASCII OK")
    print(
        f"v40d length: {len(PROMPT_DERIVER)} chars / {len(PROMPT_DERIVER.split())} words"
    )
