...
- Refers to the speaker in the FIRST PERSON. Preserve {speaker}'s \
``I`` / ``me`` / ``my`` / ``mine`` / ``myself`` from the raw message; \
do NOT rewrite them into the speaker's name. Second-person references \
(``you`` / ``your`` directed at the addressee) resolve to the \
...
of any queryable entity OTHER THAN {speaker} is named.
