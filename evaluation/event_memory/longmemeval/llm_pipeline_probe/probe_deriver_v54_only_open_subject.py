"""v54 deriver -- v45 + ONLY open-list escape hatch in subject. All
other bullets verbatim from v45 (closed CONCRETE PARTICULARS list,
short compound identifiers, short self-containment).

Isolation test:
  v53 (both lists open):      ~95.0% over 4 passes
  v45 (both lists closed):    ~97.5% over 4 passes
  v54 (open subject only):    ?

If v54 ties v45: open particulars was the culprit.
If v54 regresses: open subject framing itself hurts.
"""
...
if __name__ == "__main__":
    ...
    if non_ascii:
        ...
        print("All ASCII OK")
    print(
        f"v54 length: {len(PROMPT_DERIVER)} chars / {len(PROMPT_DERIVER.split())} words"
    )
