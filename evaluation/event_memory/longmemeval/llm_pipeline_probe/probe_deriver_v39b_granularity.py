"""v39b deriver -- rename COUNTING -> GRANULARITY.

Tests whether the conceptual term ("how coarse vs fine to chunk") reads
better than the mechanical "COUNTING". Bullets answer "what granularity
...
if __name__ == "__main__":
    ...
    if non_ascii:
        ...
        print("All ASCII OK")
    print(
        f"v39b length: {len(PROMPT_DERIVER)} chars / {len(PROMPT_DERIVER.split())} words"
    )
