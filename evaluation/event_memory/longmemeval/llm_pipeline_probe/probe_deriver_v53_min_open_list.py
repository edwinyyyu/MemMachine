"""v53 deriver -- v45 with ONLY one change: add "or any other coherent
subject" escape hatch to the subject list. All other wording preserved
verbatim from v45.

Isolation test: does just opening the subject list regress, or is the
issue in the cumulative restructuring of v48-v52?

If v53 ties v45: the open-list framing is fine, other changes
(restructuring, word swaps, expanded examples) were the problem.

If v53 regresses: the closed list itself is load-bearing in v45.
"""
...
decision, or any other coherent subject -- across any number of \
sentences, is ONE searchable thing -> ONE derivative. Co-mentioned \
...
if __name__ == "__main__":
    ...
    if non_ascii:
        ...
        print("All ASCII OK")
    print(
        f"v53 length: {len(PROMPT_DERIVER)} chars / {len(PROMPT_DERIVER.split())} words"
    )
