"""V8K prompt on gpt-5.4-nano @ low with BEFORE-ONLY neighbors.

V8K returns JSON edits to apply to the original message rather than
regenerating the message. Same 25 cases as v8j for direct comparison.
"""
...
async def main():
    ...
    seg = DeicticResolvedV8KSegmenter(
