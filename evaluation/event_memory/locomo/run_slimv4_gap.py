"""#135: does slim_v4's disambiguated keep/drop rule close the model gap?

slim_v3 baselines (3 reps each, mini judge):
  gpt-5-nano @ medium  mean 89.93   (the weak model)
  gpt-5-mini @ medium  mean 91.04

slim_v4 reframes keep/drop as a life-fact vs conversation-move dichotomy.
Re-ingest both extremes with slim_v4, 3 replicates each, search + eval.
