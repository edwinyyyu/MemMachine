"""V8J prompt on gpt-5.4-nano at minimal reasoning effort.

Probes the lowest-reasoning tier to see whether dropping reasoning
budget further changes behavior. Compares directly to v8j@low.
"""
...
async def main():
    ...
    lm = OpenAIChatCompletionsLanguageModel(
        OpenAIChatCompletionsLanguageModelParams(
            client=client, model="gpt-5.4-nano", reasoning_effort="minimal",
        )
    )
