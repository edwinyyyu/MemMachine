"""V8H and V8I prompts on gpt-5.4-nano @ low, BEFORE-ONLY neighbors.

V8H = V8G + negative examples (speaker-self-vocative WRONG forms +
first-person voice anchor example in WHAT STAYS UNCHANGED).
V8I = V8G + prompt ends with "{speaker}: " (autoregression seeding
with speaker label).

Same 25 cases as v8e/v8f/v8g.
"""
...
from probe_deictic_resolved_verbatim_v8h import DeicticResolvedV8HSegmenter
from probe_deictic_resolved_verbatim_v8i import DeicticResolvedV8ISegmenter
...
async def main():
    ...
    segs = {
        "V8H": DeicticResolvedV8HSegmenter(language_model=_lm()),
        "V8I": DeicticResolvedV8ISegmenter(language_model=_lm()),
    }
