...
async def process_question(
    ...
    for _ in range(10):
        ...
        if "<recall>" in response_text and response_text.endswith("</recall>"):
            ...
            episode_contexts = list(ided_contexts.values()) + expanded_contexts + [[episode] for memory_cued_episodes in memories_cued_episodes for episode in memory_cued_episodes]
