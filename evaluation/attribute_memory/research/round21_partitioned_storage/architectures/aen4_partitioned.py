...
DO NOT emit:
  ...
  - Cognition entries with the same predicate as a factual chain (e.g., NEVER
    emit @User.boss, @User.employer, @User.location from cognition — those
    are FACTUAL chains owned by observations).
