"""Run adversarial stress scenarios at 200/500/1000 entries."""
...
from stress_v2 import STRESS_GENERATORS  # noqa: E402
...
def main() -> None:
    ...
    try:
        ...
        out = RESULTS_DIR / "stress_v2_sweep.json"
        out.write_text(
            json.dumps(
                {
