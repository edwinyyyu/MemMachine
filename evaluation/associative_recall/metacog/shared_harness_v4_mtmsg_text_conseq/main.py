...
The system does not edit or fill it in. Because revision is free \
(re-emit same id with better text), emit a draft entry as soon as you \
have at least one concrete fact for that sub-decision, then revise \
with the same id as more facts surface.
