...
TURN_SCHEMA = {
    ...
    "properties": {
        ...
        "done": {
            "type": "boolean",
            "description": (
                "Set to true when you have nothing more worth retrieving "
                "and your step_outputs reflect the work as well as you "
                "can do it. Ends the run; the recorded step_outputs are "
                "what the user sees."
            ),
        },
    },
...
step_outputs reflect the work as well as you can do it.
    Consequence: setting `done=true` ends the run; the recorded \
step_outputs are what the user sees.
