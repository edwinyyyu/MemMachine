...
async def main():
    ...
    async def process_question(
        ...
        response, aresponse = await asyncio.gather(*response_tasks)
        ...
        return {
            ...
            "allm_latency": aresponse["latency"],
            "episodes_text": formatted_context,
            "aepisodes_text": aformatted_context,
        }
