...
async def main():
    ...
    parser.add_argument("--adata-path", required=True, help="Path to the data file")
    ...
    all_aquestions = load_longmemeval_dataset(adata_path)
    ...
    async def process_conversation(
        question: LongMemEvalItem, aquestion: LongMemEvalItem
    ):
        ...
        for session_id in session_ids:
            ...
            asession = aquestion.get_session(session_id)

            episodes = []
            for turn, aturn in zip(session, asession):
                ...
                episodes.append(
                    Episode(
                        ...
                        additional=aturn.content.strip(),
                        user_metadata={
    ...
    tasks = [
        async_with(semaphore, process_conversation(question, aquestion))
        for question, aquestion in zip(all_questions, all_aquestions)
    ]
