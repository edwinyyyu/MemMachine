...
4. When asked about time intervals, carefully subtract the times using numbers. The number of days between two events on different dates is calculated by including the start date but excluding the end date.
...
7. Your memories may include small or large jumps in time or context. Assume there are missing memories in between beyond what is provided.
...
9. Provide your answer only after reasoning carefully and showing your work.
10. As part of showing your work, check your reasoning for consistency with the memories provided.
</instructions>
...
Question: {question}
Show your step-by-step reasoning as a stream of consciousness in a paragraph without formatting, followed by your final short answer enclosed in <answer></answer> tags:
"""
...
async def main():
    ...
    async def qa_eval(
        ...
        reasoning, _, answer_part = response_text.rpartition("<answer>")
        reasoning = reasoning.strip()
        answer = answer_part.strip().partition("</answer>")[0]
