...
class DeclarativeMemory:
    ...
    async def search(
        ...
        *,
        ...
        user_derviative_node_similarities = search_derivative_nodes_results[0][1]
        assistant_derivative_node_similarities = search_derivative_nodes_results[1][1]

        ranked_scored_derivative_nodes = sorted(
            zip(
                user_derviative_node_similarities
                + assistant_derivative_node_similarities,
                similar_user_derivative_nodes
                + similar_assistant_derivative_nodes,
            ),
        ...
        matched_derivative_nodes = [
            derivative_node
            for _, derivative_node in ranked_scored_derivative_nodes
        ]
    ...
    async def _contextualize_episode(
        ...
        #         limit=max_backward_episodes if nuclear_episode.source == "Assistant" else 0,
        ...
        #     include_equal_start=False,
        #     limit=max_forward_episodes if nuclear_episode.source == "Assistant" else 0,
        #     property_filter=mangled_property_filter,
        # )
