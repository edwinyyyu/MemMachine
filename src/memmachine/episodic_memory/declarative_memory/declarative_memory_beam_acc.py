...
class DeclarativeMemory:
    ...
    async def search(
        ...
        *,
        ...
        accumulated_anchored_episode_contexts = await self._accumulate_anchored_episode_contexts(
            query,
            nuclear_episodes,
            episode_contexts,
    ...
    async def _accumulate_anchored_episode_contexts(
        ...
        while len(accumulated_episode_contexts) < limit and len(available_episode_contexts) > 0:
            candidates = [
