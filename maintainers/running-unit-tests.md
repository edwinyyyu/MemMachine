...
```bash
pytest packages/core/core_tests/ packages/server/server_tests/
```
...
```bash
pytest -v packages/core/core_tests/ packages/server/server_tests/
```
...
```bash
pytest -s packages/core/core_tests/ packages/server/server_tests/
```
...
```bash
pytest packages/core/core_tests/memmachine_core/common/test_utils.py
```
...
```bash
pytest packages/core/core_tests/memmachine_core/common/test_utils.py::test_chunk_text
```
