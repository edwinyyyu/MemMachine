...
from memmachine_core.common.vector_graph_store import Edge, Node, VectorGraphStore
...
class DeclarativeMemory:
    ...
    def string_from_episode_context(episode_context: Iterable[Episode]) -> str:
        ...
        for episode in episode_context:
            ...
            context_string += f"[{context_date} at {context_time}] {episode.source}: {json.dumps(episode.content, ensure_ascii=False)}\n"
