...
from memmachine_core.common import rw_locks
...
from memmachine_core.common.errors import ShortTermMemoryClosedError
...
from memmachine_core.episodic_memory.short_term_memory.session_data_store import (
    SessionDataStore,
)
...
class ShortTermMemoryParams(BaseModel):
    ...
    Attributes:
        ...
        data_manager (SessionDataStore): The session data store.
    ...
    data_manager: InstanceOf[SessionDataStore] | None = Field(
        default=None,
...
class ShortTermMemoryConsolidator:
    ...
    class Params(BaseModel):
        ...
        data_manager: InstanceOf[SessionDataStore] | None = None
        summary: str = ""
