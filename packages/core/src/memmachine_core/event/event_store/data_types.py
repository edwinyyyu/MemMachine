"""Data types for the event store."""
...
class EventStorePartitionConfig(BaseModel):
    """Configuration for a logical partition in an event store."""
...
class EventStorePartitionConfigMismatchError(Exception):
    ...
    def __init__(
        ...
        requested_config: EventStorePartitionConfig,
    ) -> None:
...
class EventStorePartitionAlreadyExistsError(Exception):
