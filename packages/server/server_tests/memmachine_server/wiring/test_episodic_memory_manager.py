...
@pytest.mark.asyncio
@patch("memmachine_server.wiring.episodic_memory_manager.EpisodicMemory")
async def test_create_episodic_memory_success(
    ...
    with patch(
        "memmachine_server.wiring.episodic_memory_manager.episodic_memory_params_from_config",
...
async def test_manager_close(manager: EpisodicMemoryManager, mock_episodic_memory_conf):
    ...
    with patch(
        "memmachine_server.wiring.episodic_memory_manager.EpisodicMemory",
