...
from memmachine_client import MemMachineClient, MemMachineTools, Project
from memmachine_client.models import ProjectConfig, SearchResult
...
class TestMemMachineIntegration:
    ...
    def test_add_memory_user_role(self, memory):
        ...
        assert len(result) > 0
        from memmachine_client.models import AddMemoryResult
