...
from memmachine_client.models import MemoryType
...
class TestMemMachineClient:
    ...
    def test_default_headers(self):
        ...
        assert "MemMachineClient" in str(client._session.headers["User-Agent"])
...
class TestMemory:
    def test_list_memories_calls_list_endpoint_and_parses(self):
        ...
        with patch.object(
            ...
            mock_request.assert_called_once()
            assert mock_request.call_args[0][0] == "POST"
            assert "/api/v2/memories/list" in mock_request.call_args[0][1]
            ...
            from memmachine_client.models import ListResult
