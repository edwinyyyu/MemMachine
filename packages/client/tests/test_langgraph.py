...
from memmachine_client import MemMachineTools
...
class TestFactoryFunctions:
    ...
    def test_create_add_memory_tool(self):
        ...
        result = add_fn(content="test content")  # type: ignore[call-arg]
    ...
    def test_create_add_memory_tool_with_user_id(self):
        ...
        add_fn = create_add_memory_tool(tools)
        result = add_fn(content="content", user_id="u1")  # type: ignore[call-arg]
    ...
    def test_create_search_memory_tool(self):
        ...
        result = search_fn(query="hello")  # type: ignore[call-arg]
    ...
    def test_create_search_memory_tool_with_limit(self):
        ...
        search_fn = create_search_memory_tool(tools)
        search_fn(query="hello", limit=10)  # type: ignore[call-arg]
