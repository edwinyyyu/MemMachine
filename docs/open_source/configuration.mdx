  ...
  <Accordion title="Resources">
    ...
    resources:
        databases:
          ...
          qdrant_vector_store: # VectorStore for event or vector-backed semantic memory
            ...
            config:
              ...
              https: false # Use TLS
              partition_registry: profile_storage # Relational database holding the collection registry
      ...
      **Parameter Descriptions:**
      ...
      | `config.partition_registry` | Qdrant and Milvus: the name of a relational database under `resources.databases` that holds the store's collection registry (see [Vector stores](/open_source/databases#vector-stores)). | *Required* |
