...
<AccordionGroup>
  ...
  <Accordion title="Episodic Memory">
    ...
    ```yaml
      episodic_memory:
        ...
        long_term_memory:
          ...
          event_memory_store: profile_storage
      ...
      episodic_memory:
        ...
        long_term_memory: # Configuration for long-term memory
          backend: event # Use VectorStore + EventMemoryStore. Use declarative for VectorGraphStore.
          ...
          event_memory_store: profile_storage # ID of the SQL database used by EventMemoryStore
    ...
    **Parameter Descriptions:**
    ...
    | `long_term_memory.backend`      | Long-term memory backend. Use `event` for VectorStore + EventMemoryStore, or `declarative` for VectorGraphStore. | `declarative` when omitted |
    ...
    | `long_term_memory.event_memory_store` | Event backend only: ID of a SQL database defined in `resources.databases`. | *Required for event backend* |
